                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col leading-tight">
                        <div className="flex items-center gap-1.5">
                            ...
                            <InfoHint
                                title="TOP 회전율 SKU"
                                definition="개별 SKU 단위의 월평균 회전율 상위 10건을 표시합니다."
                                bullets={[
                                    "회전율은 월간 매출 수량을 평균 재고로 나눈 값입니다 (단위: 회/월).",
                                    "SKU는 재고 관리의 가장 작은 식별 단위이며, 색상·사이즈 변형은 별도로 관리됩니다.",
                                    "발주 빈도를 상향하여 결품을 방지해야 하는 핵심 관리 대상 SKU에 해당합니다.",
                                ]}
                            />
                        </div>
