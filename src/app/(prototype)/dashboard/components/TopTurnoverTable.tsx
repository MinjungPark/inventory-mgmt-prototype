        ...
        <div className="bg-white border border-[#e2e8f0] rounded-md p-5 shadow-[0_1px_3px_rgba(0,0,0,0.04)] flex flex-col">
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                    <TrendingUp size={14} strokeWidth={2} className="text-[#0d47a1]" />
            ...
            <div className="overflow-x-auto -mx-2">
                <table className="w-full text-left">
                    <thead>
                        <tr className="border-b border-[#e2e8f0] text-[10px] font-semibold uppercase tracking-wider text-[#718096]">
                            <th className="px-2 py-2 w-8 text-center">#</th>
                            <th className="px-2 py-2">품목명</th>
                            <th className="px-2 py-2">카테고리</th>
                            <th className="px-2 py-2 text-right">회전율</th>
                    ...
                    <tbody className="divide-y divide-[#f1f5f9]">
                        {top10.map((s, idx) => (
                            <tr key={s.id} className="hover:bg-[#f8fafc] transition-colors">
                                ...
                                <td className="px-2 py-2 text-[11px] font-medium text-[#1a1a1a]">
                                    {s.name}
                                </td>
                                <td className="px-2 py-2 text-[11px] text-[#4a5568]">
                                    {s.category}
                                </td>
                                <td className="px-2 py-2 text-[11px] text-right font-semibold text-[#0d47a1] tabular-nums">
                                    {s.turnoverRate.toFixed(2)}
                                </td>
                                <td className="px-2 py-2 text-[11px] text-right text-[#4a5568] tabular-nums">
